...
declare namespace chrome {
  ...
  export namespace action {
    ...
    export function getBadgeBackgroundColor(
      ...
      callback?: (result: browserAction.ColorArray) => void
    ): void
  ...
  export namespace audio {
     ...
     */
    export const onMuteChanged: events.Event<(event: MuteChangedEvent) => void>
  ...
  export namespace automation {
    ...
    export type DescriptionFromType =
      | 'ariaDescription'
      | 'attributeExplicitlyEmpty'
      | 'buttonLabel'
      | 'popoverAttribute'
     ...
     */
    export type IntentInputEventType =
      | 'insertText'
      | 'insertLineBreak'
      | 'insertParagraph'
      | 'insertOrderedList'
     ...
     */
    export type IntentTextBoundaryType =
      | 'character'
      | 'formatEnd'
      | 'formatStart'
      | 'formatStartOrEnd'
     ...
     */
    export type TreeChangeObserverFilter =
      | 'noTreeChanges'
    ...
    export interface AutomationNode {
      ...
      hitTestWithReply(
        ...
        callback: (node: AutomationNode) => void
      ): void
    ...
    export function getTree(
      ...
      callback?: (rootNode: AutomationNode) => void
    ): void
    ...
    export function getFocus(
      callback: (focusedNode: AutomationNode) => void
    ): void
    ...
    export function addTreeChangeObserver(
      ...
      observer: (treeChange: TreeChange) => void
    ): void
  ...
  export namespace certificateProvider {
     ...
     * @since Chrome 57
     */
    export type PinRequestErrorType =
      | 'INVALID_PIN'
      | 'INVALID_PUK'
  ...
  export namespace contentSettings {
     ...
     * @since Chrome 44
     */
    export type MultipleAutomaticDownloadsContentSetting =
      | 'allow'
      | 'block'
      | 'ask'
  ...
  export namespace cookies {
     ...
     * @chrome-returns-extra since Pending
     */
    export function get(details: CookieDetails): Promise<Cookie | undefined>
  ...
  namespace _debugger {
    ...
    export function sendCommand(
       ...
       */
      callback?: (result?: { [name: string]: any }) => void
    ): void
  ...
  export namespace declarativeContent {
    ...
    export const onPageChanged: events.Event<
      never,
      PageStateMatcher,
  ...
  export namespace devtools.inspectedWindow {
    ...
    export interface Resource {
      ...
      setContent(
         ...
         */
        callback?: (error?: { [name: string]: any }) => void
      ): void
    }
  ...
  export namespace devtools.network {
    ...
    export function getHAR(
       ...
       */
      callback: (harLog: { [name: string]: any }) => void
    ): void
  }
  ...
  export namespace devtools.panels {
    ...
    export function setOpenResourceHandler(
       ...
       */
      callback?: (resource: devtools.inspectedWindow.Resource) => void
    ): void
  ...
  export namespace dom {
     ...
     */
    export function openOrClosedShadowRoot(element: HTMLElement): {
      [name: string]: any
    }
  }
  ...
  export namespace enterprise.networkingAttributes {
    ...
    export function getNetworkDetails(
      callback?: (networkAddresses: NetworkDetails) => void
    ): void
  }
  ...
  export namespace fileBrowserHandler {
     ...
     */
    export function selectFile(selectionParams: {
      /**
  ...
  export namespace fontSettings {
     ...
     * @chrome-returns-extra since Pending
     */
    export function setFont(details: {
      /**
     ...
     */
    export function clearDefaultFontSize(details?: {}): Promise<void>
     ...
     * @param details This parameter is currently unused.
     */
    export function getDefaultFontSize(details?: {}): Promise<{
      /**
       * The font size in pixels.
       */
      pixelSize: number
     ...
     * @chrome-returns-extra since Pending
     */
    export function setDefaultFontSize(details: {
      /**
       * The font size in pixels.
       */
      pixelSize: number
     ...
     * @param details This parameter is currently unused.
     */
    export function clearDefaultFixedFontSize(details?: {}): Promise<void>
     ...
     * @param details This parameter is currently unused.
     */
    export function getDefaultFixedFontSize(details?: {}): Promise<{
      /**
       * The font size in pixels.
       */
      pixelSize: number
     ...
     * @param details This parameter is currently unused.
     */
    export function clearMinimumFontSize(details?: {}): Promise<void>
     ...
     * @param details This parameter is currently unused.
     */
    export function getMinimumFontSize(details?: {}): Promise<{
      /**
       * The font size in pixels.
       */
      pixelSize: number
  ...
  export namespace instanceID {
     ...
     */
    export function getToken(getTokenParams: {
      /**
     ...
     */
    export function deleteToken(deleteTokenParams: {
      /**
  ...
  export namespace loginState {
    ...
    export function getProfileType(
      callback?: (result: ProfileType) => void
    ): void
    ...
    export function getSessionState(
      callback?: (result: SessionState) => void
    ): void
  }
  ...
  export namespace mdns {
     ...
     */
    export const onServiceList: events.Event<(services: MDnsService[]) => void>
  ...
  export namespace networking.onc {
    ...
    export type CaptivePortalStatus =
      | 'Unknown'
      | 'Offline'
      | 'Online'
      | 'Portal'
     ...
     */
    export const onNetworksChanged: events.Event<(changes: string[]) => void>

    /**
     * Fired when the list of networks has changed. Sends a complete list of GUIDs for all the current networks.
     */
    export const onNetworkListChanged: events.Event<(changes: string[]) => void>
    ...
    **This option is exposed only to Chrome's Web UI.** When called by apps, `false` is the only allowed value.
    ...
    export function getDeviceStates(
      callback: (result: DeviceStateProperties[]) => void
    ): void
  ...
  export namespace notifications {
     ...
     */
    export function getAll(
      callback: (notifications: { [name: string]: any }) => void
    ): void
    ...
    export function getPermissionLevel(
      callback: (level: PermissionLevel) => void
    ): void
  }
  ...
  export namespace permissions {
     ...
     */
    export const onAdded: events.Event<(permissions: Permissions) => void>

    /**
     * Fired when access to permissions has been removed from the extension.
     */
    export const onRemoved: events.Event<(permissions: Permissions) => void>
  ...
  export namespace printerProvider {
    ...
    export const onGetCapabilityRequested: events.Event<
      (
         ...
         */
        resultCallback: (capabilities: { [name: string]: any }) => void
      ) => void
    >
  ...
  export namespace processes {
    ...
    export const onUpdated: events.Event<
      (processes: { [name: string]: any }) => void
    >
     ...
     */
    export const onCreated: events.Event<(process: Process) => void>

    /**
     * Fired each time a process becomes unresponsive, providing the corrseponding Process object.
     */
    export const onUnresponsive: events.Event<(process: Process) => void>
     ...
     */
    export function getProcessIdForTab(tabId: number): Promise<number>
     ...
     */
    export function terminate(processId: number): Promise<boolean>
    ...
    export function getProcessInfo(
       ...
       */
      callback?: (processes: { [name: string]: any }) => void
    ): void
  }
  ...
  export namespace sockets.tcp {
     ...
     */
    export const onReceive: events.Event<(info: ReceiveInfo) => void>
     ...
     */
    export const onReceiveError: events.Event<(info: ReceiveErrorInfo) => void>
  ...
  export namespace sockets.tcpServer {
     ...
     */
    export const onAccept: events.Event<(info: AcceptInfo) => void>
     ...
     */
    export const onAcceptError: events.Event<(info: AcceptErrorInfo) => void>
  ...
  export namespace storage {
    ...
    export interface StorageArea {
      ...
      onChanged: events.Event<
        (changes: { [name: string]: StorageChange }) => void
      >
      ...
      get(
         ...
         */
        callback?: (items: { [name: string]: any }) => void
      ): void
     ...
     */
    export const onChanged: events.Event<
      (changes: { [name: string]: StorageChange }, areaName: string) => void
    >
  }
  ...
  export namespace system.storage {
     ...
     */
    export type EjectDeviceResultCode =
      | 'success'
      | 'in_use'
      | 'no_such_device'
      | 'failure'
    ...
    export function ejectDevice(
      ...
      callback?: (result: EjectDeviceResultCode) => void
    ): void
    ...
    export function getAvailableCapacity(
      ...
      callback?: (info: StorageAvailableCapacityInfo) => void
    ): void
  }
  ...
  export namespace tabs {
    ...
    export function highlight(
       ...
       */
      callback?: (window: windows.Window) => void
    ): void
  ...
  export namespace ttsEngine {
    ...
    export const onSpeak: events.Event<
      (
         ...
         */
        sendTtsEvent: (event: tts.TtsEvent) => void
      ) => void
    >
  ...
  export namespace usb {
     ...
     */
    export const onDeviceAdded: events.Event<(device: Device) => void>

    /**
     * Event generated when a device is removed from the system. See {@link onDeviceAdded} for which events are delivered.
     */
    export const onDeviceRemoved: events.Event<(device: Device) => void>
  ...
  export namespace vpnProvider {
    ...
    export const onConfigCreated: events.Event<
      (id: string, name: string, data: { [name: string]: any }) => void
    >
  ...
  export namespace webRequest {
     ...
     * @since Chrome 44
     */
    export type OnBeforeRequestOptions =
      | 'blocking'
      | 'requestBody'
      | 'extraHeaders'
     ...
     * @since Chrome 44
     */
    export type OnBeforeSendHeadersOptions =
      | 'requestHeaders'
      | 'blocking'
      | 'extraHeaders'
     ...
     * @since Chrome 44
     */
    export type OnHeadersReceivedOptions =
      | 'blocking'
      | 'responseHeaders'
      | 'extraHeaders'
